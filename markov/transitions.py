  ...
  def _count_transitions(self):
    ...
    for observation in self.observations:
      for state_transition in observation['state_transitions']:
        ...
        print "state: ", state, " action: ", action, " state_: ", state_
        print "transition_count [state][action][state_]: ", state, action, state_
  ...
  def _parse_probabilities(self, transition_count):
    ...
    for state in range(0, self.state_count):
      for action in range(0, self.action_count):
        ...
        print "state: ", state
        print "action: ", action
        print "transition_count[state][action]: ", transition_count[state][action]
        ...
        print "P[state][action]: ", P[state][action]
        print 
