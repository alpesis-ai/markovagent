...
class PolicyParser:
  ...
  def policy(self, P, rewards):
    ...
    for i in range(ITERATIONS):
      ...
      # calculating action values of each state
      for state in range(0, self.state_count):
        ...
        for action in range(0, self.action_count):
          ...
          for state_ in range(0, self.state_count):
            ...
            print "action_value += (P[state][action][state_] * state_values[state_] * GAMMA = ", action_value

          # if action_value > state_value, update the action of this state in best_policy
        ...
        print "state: ", state
        print "rewards[state]: ", rewards[state]
        print "state_value: ", state_value
        print "state_values[state] = rewards[state] + state_value = ", state_values[state]
        print
